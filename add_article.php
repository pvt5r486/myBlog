...
<body>
  <div class="container">
    ...
    <form method="POST" action="./handle/createArticle.php">
      <div class="form-group">
        <label for="title">*標題</label>
        <input type="text" class="form-control" id="title" name="title" placeholder="請輸入標題.." require>
      </div>
      <div class="form-group">
